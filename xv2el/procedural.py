...
for filename in datafiles:
    planet_names.append(
        filename.split(os.path.sep)[2].split('-')[0])  # Extract the name of the planet from the name of the file
    xv_data_arr.append(np.genfromtxt(filename, delimiter=',', names=True))
